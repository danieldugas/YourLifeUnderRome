(in another chat, we drafted together the Ten Lives Under Rome project. This is a continuation)

See the initial prompt, and first draft of Ten Lives Under Rome.

The goal is to turn this into a website, with a nice landing page (ancient rome style css), random number generator (roman dice), each profile being a page, with some generated illustrations.
